...
class JWTUtils {
  ...
  setAuthCookies(res, tokens) {
    ...
    const accessTokenExpiryMs = this.getExpirationInMs(this.accessTokenExpiry);
    const refreshTokenExpiryMs = this.getExpirationInMs(this.refreshTokenExpiry);
